...
/**
 * Shared password field with show/hide toggle — same markup/classes as
 * the original `AuthForms` implementation (User-Login / Registrierung).
 */
export function PasswordToggleInput({
  ...
  onToggle: () => void;
  placeholder?: string;
  /** Optional — e.g. `current-password` / `new-password` for password managers */
  autoComplete?: string;
}) {
  return (
