...
<?php do_action( 'wpo_wcpdf_before_signatures', $this->get_type(), $this->order ); ?>
		...
		<tr>
				...
				<table class="signature-table" align="center">
					<tr>
						<td class="signature-label">
							<?php esc_html_e( 'Signature (Sender)', 'wpo_wcpdf_pro' ); ?>
						</td>
					</tr>
				</table>
			</td>
			...
			<td class="signature-wrapper" align="center">
				<table class="signature-table" align="center">
					<tr>
						<td class="signature-label">
							<?php esc_html_e( 'Signature (Recipient)', 'wpo_wcpdf_pro' ); ?>
						</td>
					</tr>
				</table>
			</td>
...
<?php do_action( 'wpo_wcpdf_after_signatures', $this->get_type(), $this->order ); ?>
